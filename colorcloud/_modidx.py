  ...
  'syms': { 'colorcloud.behley2019iccv': { 'colorcloud.behley2019iccv.ProjectionToTensorTransform': ( 'behley2019iccv.html#projectiontotensortransform',
            ...
            'colorcloud.chen2020mvlidarnet': { 'colorcloud.chen2020mvlidarnet.ConvBNReLU': ( 'chen2020mvlidarnet.html#convbnrelu',
                                               ...
                                               'colorcloud.chen2020mvlidarnet.MVLidarNet.forward': ( 'chen2020mvlidarnet.html#mvlidarnet.forward',
                                                                                                     'colorcloud/chen2020mvlidarnet.py')},
            'colorcloud.inf_ufg_dataset': { 'colorcloud.inf_ufg_dataset.InfUFGDataset': ( 'inf_ufg_dataset.html#infufgdataset',
                                                                                          'colorcloud/inf_ufg_dataset.py'),
                                            'colorcloud.inf_ufg_dataset.InfUFGDataset.__getitem__': ( 'inf_ufg_dataset.html#infufgdataset.__getitem__',
                                                                                                      'colorcloud/inf_ufg_dataset.py'),
                                            'colorcloud.inf_ufg_dataset.InfUFGDataset.__init__': ( 'inf_ufg_dataset.html#infufgdataset.__init__',
                                                                                                   'colorcloud/inf_ufg_dataset.py'),
                                            'colorcloud.inf_ufg_dataset.InfUFGDataset.__len__': ( 'inf_ufg_dataset.html#infufgdataset.__len__',
                                                                                                  'colorcloud/inf_ufg_dataset.py'),
                                            'colorcloud.inf_ufg_dataset.InfUFGDataset.set_transform': ( 'inf_ufg_dataset.html#infufgdataset.set_transform',
                                                                                                        'colorcloud/inf_ufg_dataset.py')}}}
