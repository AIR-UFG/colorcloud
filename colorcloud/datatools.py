...
# %% auto 0
__all__ = ['SemanticKITTIDataset', 'SphericalProjectionTransform', 'ProjectionVizTransform', 'ToTensorTransform']
...
# %% ../nbs/00_datatools.ipynb 13
class ToTensorTransform(nn.Module):
    "Pytorch transform that converts the projections of a point cloud frame and its respectives label and mask from np.array to torch.tensor."
    def forward(self, frame_img, label_img, mask_img):
