...
__all__ = ['ConvBNPReLU', 'SACBlock', 'MRCIAMSingleChannel', 'MRCIAM', 'BasicEncoderBlock', 'CAM', 'EncoderModule', 'GELU', 'Mlp',
           'window_partition', 'window_reverse', 'WindowAttention', 'SwinTransformerBlock', 'BasicLayer',
           'SwinTransformer', 'Decoder', 'ConvDecoderBlock', 'TransVRNet']

# %% ../nbs/03_cheng2023TransRVNet.ipynb 4
import torch 
...
class EncoderModule(nn.Module):
    ...
    def __init__(self, 
                 in_channels:int,
                 out_channels:int)->int: # output size of basic encoder block
