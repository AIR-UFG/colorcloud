...
# %% auto 0
__all__ = ['Block', 'Encoder', 'Decoder', 'RIUNet', 'debugging_hook', 'SemanticSegmentationTask']
...
def debugging_hook(logger, step):
    "Function to use as Pytorch forward hook to log activations during training."
...
# %% ../nbs/01_biasutti2019riu.ipynb 20
class SemanticSegmentationTask(LightningModule):
    ...
    def log_activations(self, img):
        with register_module_forward_hook(debugging_hook(self.logger.experiment, self.global_step)):
                self.model(norm_img)
